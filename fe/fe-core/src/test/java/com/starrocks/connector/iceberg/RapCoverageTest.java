...
public class RapCoverageTest extends TableTestBase {
    ...
    public void testKeyOfIsThePathUnderData() { // slice 2g a-d
        ...
        Assertions.assertEquals("b/t/other/x.parquet", RapCoverage.keyOf("gs://b/t/other/x.parquet")); // v2: full path, never the basename
    ...
    @Test
    public void testDecideDistinguishesCustomRootsByFullKey() { // slice 2g v2: equal size and rows, no data/ segment
        DataFile p0 = DataFiles.builder(PartitionSpec.unpartitioned()).withPath("gs://bucket/custom/p=0/x.parquet")
